...
const page = () => {
    ...
    const {mutate: addFoodItemMutation, isPending, isError} = useAddFoodMutation()
    const defaultValues = {
        name: "",
        description: "",
        price: 0,
    ...
    const onSubmit = (data: any) : Promise<{success: boolean, error?: string}> => {
  ...
  return (
    <div className='mb-10'>
      ...
      <FoodForm schema={foodSchema} defaultValues={defaultValues} onSubmit={onSubmit} />
    </div>
  )
} 
