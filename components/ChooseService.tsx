            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader className="flex flex-col gap-2">
                  <DialogTitle className="text-xl font-bold">Take Away</DialogTitle>
                  <DialogDescription className="text-gray-500">Order ahead and collect when ready</DialogDescription>
                </DialogHeader>
                  <Input ref={addressRef} placeholder="Enter your address" />
                  <DialogFooter>
                    <DialogClose asChild>
                      <Button onClick={handleSubmit} variant="customize">Let's Select Food</Button>
                    </DialogClose>
                  </DialogFooter>
              </DialogContent>
            </Dialog>
